...
| `workbuddy` | `.workbuddy-ai/skills/ff-*` | `AGENTS.md`、`CLAUDE.md`、`.agents/skills`、`.claude/skills` | 项目由 WorkBuddy 使用，并希望团队共享项目级 Skills。 |
...
选择 `workbuddy` 时，计划只写项目级 `.workbuddy-ai/skills/`。用户级 `~/.workbuddy-ai/skills/` 不属于目标仓库事务边界，需要单独安装。
